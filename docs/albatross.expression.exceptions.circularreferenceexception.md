...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception) → [CircularReferenceException](./albatross.expression.exceptions.circularreferenceexception.md)<br>
...
Initializes a new instance of the [CircularReferenceException](./albatross.expression.exceptions.circularreferenceexception.md) class.
