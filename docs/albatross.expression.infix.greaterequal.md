...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [InfixExpression](./albatross.expression.infix.infixexpression.md) → [ComparisonInfixOperation](./albatross.expression.infix.comparisoninfixoperation.md) → [GreaterEqual](./albatross.expression.infix.greaterequal.md)<br>
