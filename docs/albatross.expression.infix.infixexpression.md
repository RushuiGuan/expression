...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [InfixExpression](./albatross.expression.infix.infixexpression.md)<br>
...
Initializes a new instance of the [InfixExpression](./albatross.expression.infix.infixexpression.md) class.
