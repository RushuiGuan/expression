...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PrefixExpression](./albatross.expression.prefix.prefixexpression.md) → [GetJsonProperty](./albatross.expression.prefix.getjsonproperty.md)<br>
