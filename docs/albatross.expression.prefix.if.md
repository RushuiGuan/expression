...
```csharp
public class If : PrefixExpression, Albatross.Expression.Nodes.IPrefixExpression, Albatross.Expression.Nodes.IExpression, Albatross.Expression.Nodes.IToken
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PrefixExpression](./albatross.expression.prefix.prefixexpression.md) → [If](./albatross.expression.prefix.if.md)<br>
...
Initializes a new instance of the [If](./albatross.expression.prefix.if.md) class.
