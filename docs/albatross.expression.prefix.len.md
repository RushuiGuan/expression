...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PrefixExpression](./albatross.expression.prefix.prefixexpression.md) → [Len](./albatross.expression.prefix.len.md)<br>
...
Initializes a new instance of the [Len](./albatross.expression.prefix.len.md) class.
