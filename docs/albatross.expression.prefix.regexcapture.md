...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PrefixExpression](./albatross.expression.prefix.prefixexpression.md) → [RegexCapture](./albatross.expression.prefix.regexcapture.md)<br>
