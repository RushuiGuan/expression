...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PrefixExpression](./albatross.expression.prefix.prefixexpression.md) → [ShortMonthName](./albatross.expression.prefix.shortmonthname.md)<br>
