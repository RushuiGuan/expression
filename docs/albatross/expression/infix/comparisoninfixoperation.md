...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [InfixExpression](./albatross/expression/infix/infixexpression) → [ComparisonInfixOperation](./albatross/expression/infix/comparisoninfixoperation)<br>
...
Initializes a new instance of the [ComparisonInfixOperation](./albatross/expression/infix/comparisoninfixoperation) class.
