...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [InfixExpression](./albatross/expression/infix/infixexpression) → [ComparisonInfixOperation](./albatross/expression/infix/comparisoninfixoperation) → [Equal](./albatross/expression/infix/equal)<br>
...
Initializes a new instance of the [Equal](./albatross/expression/infix/equal) class.
