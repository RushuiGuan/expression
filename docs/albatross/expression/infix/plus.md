...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [InfixExpression](./albatross/expression/infix/infixexpression) → [Plus](./albatross/expression/infix/plus)<br>
...
Initializes a new instance of the [Plus](./albatross/expression/infix/plus) class.
