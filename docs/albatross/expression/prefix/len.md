...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PrefixExpression](./albatross/expression/prefix/prefixexpression) → [Len](./albatross/expression/prefix/len)<br>
...
Initializes a new instance of the [Len](./albatross/expression/prefix/len) class.
