...
namespace Albatross.Expression.Tokens
{
    ...
    public class VariableToken : IVariableToken {
		...
		static Regex VariableNameRegex = new Regex(VariableNamePattern,  RegexOptions.Singleline | RegexOptions.IgnorePatternWhitespace);
		...
		public virtual int CompareTo(IOperandToken other) {
